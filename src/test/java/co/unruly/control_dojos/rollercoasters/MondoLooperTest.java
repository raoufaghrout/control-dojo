...
public class MondoLooperTest {
    ...
    public void rejectRidersUnder1m20Tall() {
        ...
        assertThat(RollercoasterValidators.forMondoLooper().apply(BASHFUL), is(failure("You must be 1m20 tall to ride")));
    }
    ...
    public void rejectRidersOver2m10Tall() {
        ...
        assertThat(RollercoasterValidators.forMondoLooper().apply(FEZZEK), is(failure("You must be under 2m10 tall to ride")));
    }
}
